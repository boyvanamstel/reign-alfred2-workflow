...
* XML Events
  ...
  s.files = ["CHANGES", "MIT-LICENSE", "README.md", "Rakefile", "doc/jamis.rb", "doc/releases/builder-1.2.4.rdoc", "doc/releases/builder-2.0.0.rdoc", "doc/releases/builder-2.1.1.rdoc", "lib/blankslate.rb", "lib/builder.rb", "lib/builder/blankslate.rb", "lib/builder/version.rb", "lib/builder/xchar.rb", "lib/builder/xmlbase.rb", "lib/builder/xmlevents.rb", "lib/builder/xmlmarkup.rb", "test/performance.rb", "test/preload.rb", "test/test_blankslate.rb", "test/test_eventbuilder.rb", "test/test_markupbuilder.rb", "test/test_method_caching.rb", "test/test_namecollision.rb", "test/test_xchar.rb", "rakelib/publish.rake", "rakelib/tags.rake"]
